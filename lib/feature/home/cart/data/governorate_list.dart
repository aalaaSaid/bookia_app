...
class Governorate {
  ...
  factory Governorate.fromRawJson(String str) => Governorate.fromJson(json.decode(str));
...
List<Governorate>getGovernorate(){
  return governorate.map((e)=>Governorate.fromJson(e)).toList();
}